        ...
        <div class="container">
          ...
          <div id="navbarMenuHeroC" class="navbar-menu">
            <div class="navbar-end">
              ...
              <a class="navbar-item is-active" href="#">Contact us</a>
              <a class="navbar-item" href="membri.php">Member Area</a>
              <a class="navbar-item" href="contact.php">ITA</a>
            </div>
          </div>
        </div>
      </nav>
...
<div class="hero-body">
    <div class="container has-text-centered">
    <h1 class="title"> Send us an email: eteamsquadracorse@gmail.com <h1>
    <h1 class="title"> Come to visit us: Via Giunta Pisano, 11 </h1>
    </div>
    </div>
