        ...
        <div class="container">
          ...
          <div id="navbarMenuHeroC" class="navbar-menu">
            <div class="navbar-end">
              ...
              <a class="navbar-item" href="index.php">ITA</a>
            </div>
          </div>
        </div>
      </nav>
...
<div class="hero-body">
    ...
    <?php 
        ...
        $sql = "SELECT text_eng FROM descriptions WHERE position = 'index_1'";
        $result="";
    ...
    <?php 
        ...
        foreach($images as $image){
            ...
            echo '<button class="button is-dark is-large is-fullwidth" ><a href="contact_en.php"> CONTACT US </a> </button>';
            echo '</div>';
            echo '</div></section>';
        }         
    ?>
